      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Configure your MetaMask wallet for certificate issuance on Sepolia testnet
          </p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <Alert>
              <AlertDescription className="space-y-2">
                <p><strong>Network:</strong> Sepolia Testnet (Chain ID: {SEPOLIA_CONFIG.chainId})</p>
                <p><strong>Note:</strong> Make sure your MetaMask wallet is connected to Sepolia testnet and has some test ETH for gas fees.</p>
                <a 
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>
              3. Certificate data will be stored on IPFS and the hash will be recorded on Sepolia blockchain
            </p>
            <p>
